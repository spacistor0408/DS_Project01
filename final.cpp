...
public:
    ...
    void Print() {
        ...
        for ( int i = 0 ; i < arrayLength ; i++ ) {
            cout << maxHeap[i].rid << " " << maxHeap[i].value << endl ;
        }
...
/*
                cout << "MinHeap :" ;
                cout << cur << " " << deap[cur].value << "\t" ;
                cout << "parent node : " << parent << " " << deap[parent].value << endl ; // debug line
*/
...
/*
                cout << "MaxHeap :" ;
                cout << cur << " " << deap[cur].value << "\t" ;
                cout << "correspond node : " << correspond << " " << deap[correspond].value << endl ; // debug line
*/
    ...
    void Print() {
        cout << "size : " << arrayLength << endl ;
        for ( int i = 0 ; i < arrayLength ; i++ ) {
            cout << deap[i].rid << " " << deap[i].value << endl ;
        } // for

        cout << bottom << " " << cur << endl ;
